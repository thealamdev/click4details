...
class EngineController extends Controller
{
    ...
    {
        $collections = Engine::query()->with('translate')->orderBy('slug')->get();
        return view('content.package.vehicle.engine.index', compact('collections'));
    }
    ...
    {
        return view('content.package.vehicle.engine.create');
    }
    ...
    {
        return view('content.package.vehicle.engine.update', compact('engine'));
    }
