...
class TransmissionController extends Controller
{
    ...
    {
        $collections = Transmission::query()->with('translate')->orderBy('slug')->get();
        return view('content.package.vehicle.transmission.index', compact('collections'));
    }
    ...
    {
        return view('content.package.vehicle.transmission.create');
    }
    ...
    {
        return view('content.package.vehicle.transmission.update', compact('transmission'));
    }
