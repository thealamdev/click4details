...
class AvailableController extends Controller
{
    ...
    {
        $collections = Available::query()->with('translate')->orderBy('slug')->get();
        return view('content.package.vehicle.available.index',compact('collections'));
    }
    ...
    {
        return view('content.package.vehicle.available.create');
    }
    ...
    {
        return view('content.package.vehicle.available.update', compact('available'));
    }
