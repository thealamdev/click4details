...
class GalleryController extends Controller
{
    ...
    {
        return view('content.package.vehicle.product.gallery', compact('vehicle'));
    }

    public function property_index(Property $property){
    ...
    public function storeProperty(Property $property, StoreGalleryRequest $request): RedirectResponse
    {
        if ($request->validated()) {
            $images = [];
