...
class BrandController extends Controller
{
    ...
    {
        $collections = Brand::query()->with('translate')->orderBy('slug')->latest()->get();
        return view('content.package.vehicle.brand.index', compact('collections'));
    }
    ...
    {
        return view('content.package.vehicle.brand.create');
    }
    ...
    {
        return view('content.package.vehicle.brand.update', compact('brand'));
    }
