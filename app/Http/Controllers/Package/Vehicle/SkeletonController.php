...
class SkeletonController extends Controller
{
    ...
    {
        $collections = Skeleton::query()->with('translate')->orderBy('slug')->get();
        return view('content.package.vehicle.skeleton.index', compact('collections'));
    }
    ...
    {
        return view('content.package.vehicle.skeleton.create');
    }
    ...
    {
        return view('content.package.vehicle.skeleton.update', compact('skeleton'));
    }
