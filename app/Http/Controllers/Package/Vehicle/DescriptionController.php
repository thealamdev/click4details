...
class DescriptionController extends Controller
{
    ...
    {
        return view('content.package.vehicle.product.detail', compact('vehicle'));
    }
    ...
    public function store(Vehicle $vehicle, StoreDescriptionRequest $request): RedirectResponse
    {
        if ($request->validated()) {
            ...
            return Redirect::route('admin.vehicle.gallery.index', ['vehicle' => $vehicle->getKey()])->with('status', $response);
        }
