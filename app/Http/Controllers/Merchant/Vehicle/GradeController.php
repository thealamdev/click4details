...
class GradeController extends Controller
{
    ...
    {
        $collections = Grade::query()->with('translate')->get();
        return view('content.merchant.vehicle.grade.index', compact('collections'));
    }
    ...
    {
        return view('content.merchant.vehicle.grade.create');
    }
    ...
    {
        return view('content.merchant.vehicle.grade.update', compact('grade'));
    }
