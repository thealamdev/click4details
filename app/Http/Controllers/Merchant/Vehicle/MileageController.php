...
class MileageController extends Controller
{
    ...
    {
        $collections = Mileage::query()->with('translate')->get();
        return view('content.merchant.vehicle.mileage.index', compact('collections'));
    }
    ...
    {
        return view('content.merchant.vehicle.mileage.create');
    }
    ...
    {
        return view('content.merchant.vehicle.mileage.update', compact('mileage'));
    }
