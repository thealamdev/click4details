...
class ConditionController extends Controller
{
    ...
    {
        $collections = Condition::query()->with('translate')->get();
        return view('content.merchant.vehicle.condition.index', compact('collections'));
    }
    ...
    {
        return view('content.merchant.vehicle.condition.create');
    }
    ...
    {
        return view('content.merchant.vehicle.condition.update', compact('condition'));
    }
