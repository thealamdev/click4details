...
class FuelController extends Controller
{
    ...
    {
        $collections = Fuel::query()->with('translate')->get();
        return view('content.merchant.vehicle.fuel.index', compact('collections'));
    }
    ...
    {
        return view('content.merchant.vehicle.fuel.create');
    }
    ...
    {
        return view('content.merchant.vehicle.fuel.update', compact('fuel'));
    }
