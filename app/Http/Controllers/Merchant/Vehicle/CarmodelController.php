...
class CarmodelController extends Controller
{
    ...
    {
        $collections = Carmodel::query()->with('translate')->get();
        return view('content.merchant.vehicle.model.index',compact('collections'));
    }
    ...
    public function create()
    {
        ...
        return view('content.merchant.vehicle.model.create');
    }
    ...
    {
        return view('content.merchant.vehicle.model.update', compact('model'));
    }
