...
class FeedbackMessageHandler extends HandlerAdapter
{
    /**
    ...
    {
        $instance = FeedbackMessage::query()->create(array_merge_recursive($request->only('message')));
        return $instance;
    }
    ...
    {
        $process = $instance instanceof Model ? $instance : FollowupMessage::query()->findOrFail($instance->feedbackMessage);
