...
class AvailableHandler extends HandlerAdapter
{
    /**
    ...
    {
        $instance = Available::query()->create(array_merge_recursive($request->only('status'), [
    ...
    {
        $process = $instance instanceof Model ? $instance : Available::query()->findOrFail($instance->edition);
