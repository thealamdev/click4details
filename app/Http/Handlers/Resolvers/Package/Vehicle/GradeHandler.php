...
class GradeHandler extends HandlerAdapter
{
    /**
    ...
    {
        $instance = Grade::query()->create(array_merge_recursive($request->only('status'), [
    ...
    {
        $process = $instance instanceof Model ? $instance : Grade::query()->findOrFail($instance->grade);
