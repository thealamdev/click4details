...
class RegistrationtHandler extends HandlerAdapter
{
    /**
    ...
    {
        $instance = Registration::query()->create(array_merge_recursive($request->only('status'), [
    ...
    {
        $process = $instance instanceof Model ? $instance : Registration::query()->findOrFail($instance->edition);
