...
class TransmissionHandler extends HandlerAdapter
{
    /**
    ...
    {
        $instance = Transmission::query()->create(array_merge_recursive($request->only('status'), [
    ...
    {
        $process = $instance instanceof Model ? $instance : Fuel::query()->findOrFail($instance->transmission);
