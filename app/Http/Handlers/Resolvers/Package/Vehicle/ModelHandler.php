...
class ModelHandler extends HandlerAdapter
{
    /**
    ...
    {
        $instance = Carmodel::query()->create(array_merge_recursive($request->only('status'), [
    ...
    {
        $process = $instance instanceof Model ? $instance : Carmodel::query()->findOrFail($instance->edition);
