...
class FuelHandler extends HandlerAdapter
{
    /**
    ...
    {
        $instance = Fuel::query()->create(array_merge_recursive($request->only('status'), [
    ...
    {
        $process = $instance instanceof Model ? $instance : Fuel::query()->findOrFail($instance->fuel);
