...
class SkeletonHandler extends HandlerAdapter
{
    /**
    ...
    {
        $instance = Skeleton::query()->create(array_merge_recursive($request->only('status'), [
    ...
    {
        $process = $instance instanceof Model ? $instance : Fuel::query()->findOrFail($instance->skeleton);
