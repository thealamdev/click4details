...
class ColorHandler extends HandlerAdapter
{
    /**
    ...
    {
        $instance = Color::query()->create(array_merge_recursive($request->only('status'), [
    ...
    {
        $process = $instance instanceof Model ? $instance : Color::query()->findOrFail($instance->edition);
