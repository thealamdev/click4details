...
class EngineHandler extends HandlerAdapter
{
    /**
    ...
    {
        $instance = Engine::query()->create(array_merge_recursive($request->only('status'), [
    ...
    {
        $process = $instance instanceof Model ? $instance : Engine::query()->findOrFail($instance->engine);
