...
class TypeHandler extends HandlerAdapter
{
    /**
    ...
    {
        $instance = Type::query()->create(array_merge_recursive($request->only('status'), [
    ...
    {
        $process = $instance instanceof Model ? $instance : Type::query()->findOrFail($instance->edition);
