...
class PriceUnitHandler extends HandlerAdapter
{
    /**
    ...
    {
        $instance = Priceunit::query()->create(array_merge_recursive($request->only('status'), [
    ...
    {
        $process = $instance instanceof Model ? $instance : Priceunit::query()->findOrFail($instance->edition);
