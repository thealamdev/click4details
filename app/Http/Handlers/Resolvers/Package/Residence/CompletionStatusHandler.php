...
class CompletionStatusHandler extends HandlerAdapter
{
    /**
    ...
    {
        $instance = CompletionStatus::query()->create(array_merge_recursive($request->only('status'), [
    ...
    {
        $process = $instance instanceof Model ? $instance : CompletionStatus::query()->findOrFail($instance->completionStatus);
