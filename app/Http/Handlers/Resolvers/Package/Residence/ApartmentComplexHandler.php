...
class ApartmentComplexHandler extends HandlerAdapter
{
    /**
    ...
    {
        $instance = ApartmentComplex::query()->create(array_merge_recursive($request->only('status'), [
    ...
    {
        $process = $instance instanceof Model ? $instance : ApartmentComplex::query()->findOrFail($instance->apartmentComplex);
