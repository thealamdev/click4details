...
class UpdateTransmissionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        foreach (Locale::iterator() as $lang) {
            ...
            $rule[$title]   = ['required', 'string', Rule::unique('translates', 'title')->where('translate_type', Transmission::class)->where('local', $lang)->ignore($this->transmission->id, 'translate_id')];
        }
