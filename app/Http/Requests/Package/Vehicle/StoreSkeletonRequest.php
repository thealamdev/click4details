...
class StoreSkeletonRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        foreach (Locale::iterator() as $lang) {
            ...
            $rule[$title]   = ['required', 'string', Rule::unique('translates', 'title')->where('translate_type', Skeleton::class)->where('local', $lang)];
        }
