        ...
        <div class="row">
            <div class="col-12 col-md-8">
                ...
                <div class="alert alert-success d-flex align-items-center justify-content-between" role="alert">
                    <div>
                        <h3 class="m-0">
                            {{ __('module.detail.price', ['total' => number_format($detail->fixed_price > 0 ? ($detail->fixed_price ?? 0) + ($detail->additional_price ?? 0) : $detail->price ?? 10)]) }}
                        </h3>

                        @if ($detail->negotiable == 1)
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item d-flex justify-content-between align-items-center py-0 pb-1 border-0">
                                            <span class="fw-500">{{ __('module.detail.features.brand', [], $translate) }}
                                                :</span>
                                            <span>{{ toLocaleString($detail?->brand->translate, $translate) }}</span>
                                        </li>

                                        <li class="list-group-item d-flex justify-content-between align-items-center py-0 pb-1 border-0">
                                            <span class="fw-500">{{ __('module.detail.features.model', [], $translate) }}
                                                :</span>
                                            @if ($detail?->carmodel)
                                                <span>{{ toLocaleString($detail?->carmodel?->translate, $translate) }}</span>
                                            @else
                                                {{ '--' }}
                                            @endif
                                        </li>
                                ...
                                <div class="col-12 col-md-6">
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center py-0 pb-1 border-0">
                                            <span class="fw-500">{{ __('module.detail.features.edition', [], $translate) }}
                                                :</span>
                                            <span>
                                                @if ($detail?->edition)
                                                    {{ toLocaleString($detail?->edition?->translate, $translate) }}
                                                @else
                                                    {{ '--' }}
                                                @endif
                                            </span>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center py-0 pb-1 border-0">
                                            <span class="fw-500">{{ __('module.detail.features.manufacture', [], $translate) }}
                                                :</span>
                                            <span>{{ toLocaleNumber(number_format($detail?->manufacture), $translate) }}</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-12 col-md-6">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item d-flex justify-content-between align-items-center py-0 pb-1 border-0">
                                            <span class="fw-500">{{ __('module.detail.features.engine', [], $translate) }}
                                                :</span>
                                            @if (!empty($detail?->engines))
                                                <span>{{ toLocaleNumber($detail?->engines, $translate) }} cc</span>
                                            @else
                                                <span>{{ toLocaleString($detail?->engine?->translate, $translate) }}</span>
                                            @endif

                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center py-0 pb-1 border-0">
                                            <span class="fw-500">{{ __('module.detail.features.condition', [], $translate) }}
                                                :</span>
                                            <span>{{ toLocaleString($detail?->condition->translate, $translate) }}</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-12 col-md-6">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item d-flex justify-content-between align-items-center py-0 pb-1 border-0">
                                            <span class="fw-500">{{ __('module.detail.features.fuel', [], $translate) }}
                                                :</span>
                                            <span>{{ toLocaleString($detail?->fuel->translate, $translate) }}</span>
                                        </li>

                                        </li>

                                        <li class="list-group-item d-flex justify-content-between align-items-center py-0 pb-1 border-0">
                                            <span class="fw-500">{{ __('module.detail.features.skeleton', [], $translate) }}
                                                :</span>
                                            <span>{{ toLocaleString($detail?->skeleton->translate, $translate) }}</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-12 col-md-6">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item d-flex justify-content-between align-items-center py-0 pb-1 border-0">
                                            <span class="fw-500">{{ __('module.detail.features.mileage', [], $translate) }}
                                                :</span>

                                            @if (!empty($detail?->mileages))
                                                <span>
                                                    {{ toLocaleNumber($detail->mileages, $translate) }} Km
                                                </span>
                                            @else
                                                <span>
                                                    {{ toLocaleString($detail->mileage?->translate, $translate) }}
                                                </span>
                                            @endif
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center py-0 pb-1 border-0">
                                            <span class="fw-500">{{ __('module.detail.features.transmission', [], $translate) }}
                                                :</span>
                                            <span>{{ toLocaleString($detail?->transmission->translate, $translate) }}</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-12 col-md-6">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item d-flex justify-content-between align-items-center py-0 pb-1 border-0">
                                            <span class="fw-500">{{ __('module.detail.features.registration', [], $translate) }}
                                                :</span>
                                            <span>
                                                @if ($detail?->registration)
                                                    {{ toLocaleNumber(number_format($detail?->registration), $translate) }}
                                                @else
                                                    {{ '--' }}
                                                @endif
                                            </span>
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center py-0 pb-1 border-0">
                                            <span class="fw-500">{{ __('module.detail.features.grade', [], $translate) }}
                                                :</span>
                                            <span>
                                                @if ($detail->grade)
                                                    {{ toLocaleString($detail->grade?->translate, $translate) }}
                                                @else
                                                    {{ '--' }}
                                                @endif
                                            </span>
                                ...
                                <div class="col-12 col-md-6">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item d-flex justify-content-between align-items-center py-0 pb-1 border-0">
                                            <span class="fw-500">{{ __('module.detail.features.color', [], $translate) }}
                                                :</span>
                                            @if ($detail?->color)
                                                <span>{{ toLocaleString($detail?->color?->translate, $translate) }}</span>
                                            @else
                                                {{ '--' }}
                                            @endif
                                        </li>
                                ...
                                <div class="col-12 col-md-6">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item d-flex justify-content-between align-items-center py-0 pb-1 border-0">
                                            <span class="fw-500">Chassis Number
                                                :</span>
                                            @if ($detail?->chassis_number)
                                                <span>{{ $detail?->chassis_number }}</span>
                                            @else
                                                {{ '--' }}
                                            @endif
                                        </li>
                    ...
                    <div class="card rounded border border-slate-200 mb-3">
                        <div class="card-body pb-2">
                            <div class="row">
                                ...
                                @foreach ($detail->vehicle_feature as $f)
                                    @php
                                    ...
                                    @if (!in_array($featureTitle, $uniqueFeatures))
                                        <div class="col-lg-4 col-md-4 px-4">
                                            ...
                                            <span>
                                                @foreach ($detail->vehicle_feature as $detailFeature)
                                                    @if ($detailFeature->feature?->title === $featureTitle)
                                                        {{-- <i class="fa-solid fa-chevron-right"></i> --}}
                                                        <span class="ps-2">{{ $detailFeature->detail?->title }}</span>
                                                        <br>
                                                    @endif
                                                @endforeach
                                            </span>
