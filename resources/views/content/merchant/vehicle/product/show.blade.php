                        ...
                        <form action="{{ route('merchant.stockList') }}" method="GET">
                            <div class="form-content d-flex justify-content-between">
                                <div class="mt-3 ps-3">
                                    ...
                                    <label for="fixed_price" class="fs-5">Fixed</label>
                                </div>

                                <div class="mt-3 ps-3">
                                    <input type="radio" name="price" value="{{ base64_encode('asking_price') }}">
                                    <label for="asking_price" class="fs-5 green_color">Asking</label>
                                </div>
                                <input type="hidden" name="merchant_id" value="{{ base64_encode($merchant_id ?? 0) }}">

                                <button class="btn btn-success ms-5" type="submit"><i class="fa-solid fa-share"></i>
                                    STOCK</button>
                            </div>
                        </form>
                    </div>
                                    ...
                                    <div class="card-body p-2">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form
                                                            action="{{ route('merchant.vehicle.product.vehicleUpdate', ['product' => $each->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('put')
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="mt-4 mb-3 d-flex justify-content-between">
                                                                    <a class="btn btn-danger"
                                                                        href="{{ route('merchant.vehicle.product.edit', ['product' => $each->id]) }}">Advanced
                                                                    </a>
                                                                    <a href="{{ route('merchant.vehicle.purchase-price.directView', ['vehicle' => $each->id]) }}"
                                                                        class="btn btn-primary" id="purchaseBox">
                                        ...
                                        <p class="d-flex justify-content-between">
                                            @php
                                                ...
                                                if (
                                                    toLocaleString($each?->available?->translate) ===
                                                    'Available at Friends Showroom'
                                                ) {
