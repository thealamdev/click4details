...
@section('content')
    ...
    <div class="container">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                <h4 class="mb-0">Create Merchant Vehicle</h4>
                <p>Prior to create resource, make sure asterisk (*) signs are filled</p>
            </div>
        </div>
        <div class="card rounded border border-gray-300">
            <div class="card-body">
                <form action="{{ route('merchant.vehicle.product.store') }}" method="POST" accept-charset="utf-8"
                    ...
                    <div class="row gx-3">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('title.bn') {{ 'is-invalid' }} @enderror"
                                    name="title[bn]" value="{{ old('title.bn') }}" required />
                                @error('title.bn')
                                    <div class="invalid-feedback text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <select class="form-select @error('category_id') {{ 'is-invalid' }} @enderror"
                                    ...
                                    @foreach ($composeCategory as $each)
                                        @if (in_array($each->title, ['Car', 'Vehicle']))
                                            <option value="{{ $each->id }}" @selected(old('category_id') == $each->id)>
                                                {{ $each->title }}</option>
                                        @endif
                                    @endforeach
                                </select>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                <label class="merchant form-label fw-500 mb-1" for="merchant_id">Merchant<span
                                        class="ms-1 text-red-600">*</span></label>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('condition_id') {{ 'is-invalid' }} @enderror"
                                    ...
                                    @foreach ($composeCondition as $each)
                                        <option value="{{ $each->id }}" @selected(old('condition_id') == $each->id)>
                                            {{ $each->title }}</option>
                                    @endforeach
                                </select>
                                @error('condition_id')
                        ...
                        {{-- <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('edition_id') {{ 'is-invalid' }} @enderror"
                                    name="edition_id" required>
                                    <option selected disabled>Please Select...</option>
                                    @foreach ($composeEdition as $each)
                                        <option value="{{ $each->id }}" @selected(old('edition_id') == $each->id)>
                                            {{ $each->title }}</option>
                                    @endforeach
                                </select>
                                @error('edition_id')
                                ...
                                <select class="form-select edition @error('edition_id') {{ 'is-invalid' }} @enderror"
                                    ...
                                    @foreach ($composeEdition as $each)
                                        <option value="{{ $each->id }}"
                                            {{ old('edition_id') == $each->id ? 'selected' : '' }}>
                                            {{ $each->title }}</option>
                                    @endforeach
                                </select>
                                @error('edition_id')
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                <label class="form-label fw-500 mb-1" for="engines">Engine<span
                                        class="ms-1 text-red-600">*</span></label>
                                <input type="number" class="form-control" name="engines"
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                <label class="form-label fw-500 mb-1" for="mileages">Mileages<span
                                        class="ms-1 text-red-600">*</span></label>
                                <input type="number" class="form-control" name="mileages"
                                    placeholder="enter mileages..">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('fuel_id') {{ 'is-invalid' }} @enderror"
                                    ...
                                    @foreach ($composeFuel as $each)
                                        <option value="{{ $each->id }}" @selected(old('fuel_id') == $each->id)>
                                            {{ $each->title }}</option>
                                    @endforeach
                                </select>
                                @error('fuel_id')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('skeleton_id') {{ 'is-invalid' }} @enderror"
                                    ...
                                    @foreach ($composeSkeleton as $each)
                                        <option value="{{ $each->id }}" @selected(old('skeleton_id') == $each->id)>
                                            {{ $each->title }}</option>
                                    @endforeach
                                </select>
                                @error('skeleton_id')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('transmission_id') {{ 'is-invalid' }} @enderror"
                                    ...
                                    @foreach ($composeTransmission as $each)
                                        <option value="{{ $each->id }}" @selected(old('transmission_id') == $each->id)>
                                            {{ $each->title }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="code" id="code" class="form-control">
                                    ...
                                    @foreach ($codes as $code)
                                        <option value="{{ old('code', $code) }}">{{ $code }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                <label class="form-label fw-500 mb-1" for="code">Code<span
                                        class="ms-1 text-red-600">*</span></label>
                                <select name="code" id="codes"
                                    class="form-control name @error('code') {{ 'is-invalid' }} @enderror">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('grade_id') {{ 'is-invalid' }} @enderror"
                                    ...
                                    @foreach ($composeGrade as $each)
                                        <option value="{{ $each->id }}" @selected(old('grade_id') == $each->id)>
                                            {{ $each->title }}</option>
                                    @endforeach
                                </select>
                                @error('grade_id')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('available_id') {{ 'is-invalid' }} @enderror"
                                    ...
                                    @foreach ($composeAvailable as $each)
                                        <option value="{{ $each->id }}" @selected(old('available_id') == $each->id)>
                                            {{ $each->title }}</option>
                                    @endforeach
                                </select>
                                @error('grade_id')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('registration_id') {{ 'is-invalid' }} @enderror"
                                    ...
                                    @foreach ($composeRegistration as $each)
                                        <option value="{{ $each->id }}" @selected(old('registration_id') == $each->id)>
                                            {{ $each->title }}</option>
                                    @endforeach
                                </select>
                                @error('grade_id')
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                <label class="form-label fw-500 mb-1" for="purchase_price">Purchase Price<span
                                        class="ms-1 text-red-600"></span></label>
                                <input type="number" min="10000" placeholder="enter purchase price"
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                <label class="form-label fw-500 mb-1" for="fixed_price">Fixed Price<span
                                        class="ms-1 text-red-600">*</span></label>
                                <input type="number" min="10000" placeholder="enter fixed price"
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                <label class="form-label fw-500 mb-1" for="price">Asking Price<span
                                        class="ms-1 text-red-600">*</span></label>
                                <input type="number" min="10000" placeholder="enter asking price"
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" placeholder="Enter Engine Number"
                                    ...
                                    name="engine_number" value="{{ old('engine_number') }}" />
                                @error('engine_number')
                                    <div class="invalid-feedback text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" placeholder="Enter Chassis Number"
                                    ...
                                    name="chassis_number" value="{{ old('chassis_number') }}" />
                        ...
                        <div class="col-12 col-md-6 d-none">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('is_approved') {{ 'is-invalid' }} @enderror"
                                    ...
                                    <option selected disabled>Please Select...</option>
                                    <option value="1" selected @selected(old('is_approved') == '1')>Approved</option>
                        ...
                        <div class="col-12 col-md-6 d-none">
                            <div class="form-group mb-3">
                                ...
                                <input type="datetime-local"
                                    ...
                                    name="publish_at" value="{{ old('publish_at', $currentDate) }}" required />
                                @error('publish_at')
                                    <div class="invalid-feedback text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-6 d-none">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('is_feat') {{ 'is-invalid' }} @enderror"
                                    ...
                                    <option selected disabled>Please Select...</option>
                                    <option value="1" selected @selected(old('is_feat') == '1')>Yes</option>
                                    <option value="0" @selected(old('is_feat') == '0')>No</option>
                                </select>
                                @error('is_feat')
                                    <div class="invalid-feedback text-red-600">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-12 col-md-6 d-none">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('status') {{ 'is-invalid' }} @enderror"
                                    ...
                                    <option selected disabled>Please Select...</option>
                                    <option value="1" selected @selected(old('status') == '1')>Active</option>
    ...
    <script>
        $(document).ready(function() {
            $('.edition').on('change', function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: '{{ route('merchant.vehicle.product.create') }}',
                    dataType: 'json',
                    data: {
                    ...
                    success: function(response) {
                        ...
                        featuresDetail.forEach(function(detailFeature) {
                            ...
                            if (!uniqueFeatures.includes(featureTitle)) {
                                var featureItemDiv = $('<div>').addClass(
                                    'col-lg-3');
