...
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div>
            ...
            <p class="mb-0">Manage all the user details</p>
        </div>
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="{{ route('admin.user.edit', ['user' => $each->id]) }}"
                                                class="dropdown-item">Edit</a>
                                            <form action="{{ route('admin.user.delete', ['user' => $each->id]) }}"
                                                method="POST">
                                                @method('DELETE')
                                                @csrf
                                                <button type="submit" class="dropdown-item">Trash</button>
                                            </form>
                                            <a href="{{ route('admin.user.show', ['user' => $each->id]) }}"
