<div class="modal fade detail{{ $each?->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
    ...
    @php
        $requirement = $schedule['requirements']?->where('id', $each->id)->first();
    @endphp
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Requirement part !-->
                @include('content.admin.user.partials.dashboard.requirement')

                <!-- Follow up part !-->
                <hr>
                @include('content.admin.user.partials.dashboard.followup-feedback')
            </div>
