...
<div class="container">
    ...
    <div class="card rounded border border-gray-300">
        <div class="card-body">
            <form action="{{ route('admin.category.store') }}" method="POST" accept-charset="utf-8" autocomplete="on" class="need-validation" novalidate>
                @csrf
                <div class="row g-3">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            <label class="form-label fw-500 mb-1" for="title[bn]">Title in Bengali<span class="ms-1 text-red-600">*</span></label>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-select" name="is_feat" required>
                                <option selected disabled>Please Select...</option>
                                <option value="1" @selected(old('is_feat')=='1' )>Yes</option>
