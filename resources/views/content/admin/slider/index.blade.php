...
<div class="d-flex align-items-center justify-content-between mb-3">
    <div>
        ...
        <p class="mb-0">Manage all the sliders datalist</p>
    </div>
    <div class="dropdown me-1">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuOffset">
            <li>
                <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.slider.create') }}">
                    Create Record<i class="fa-solid fa-plus text-body text-opacity-50"></i>
                </a>
                <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.slider.index') }}">
        ...
        <table id="dataTable" class="table table-striped" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $each->model }}</td>
                    <td class="fw-500"><a href="{{ $each->link ? sprintf('%s/%s', config('app.url'), $each->link) : 'javascript:;' }}">Preview</a></td>
                    ...
                    <td class="text-center">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="{{ route('admin.slider.edit', ['slider' => $each->id]) }}" class="dropdown-item">Edit</a>
                                <form action="{{ route('admin.slider.delete', ['slider' => $each->id]) }}" method="POST">
                                    @csrf
                                    @method('delete')
