...
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div>
            <h4 class="mb-0">Furnished Status</h4>
        ...
        <div class="dropdown me-1">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuOffset">
                <li>
                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.residence.furnished-status.create') }}">
                        Create Record<i class="fa-solid fa-plus text-body text-opacity-50"></i>
                    </a>
                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.residence.furnished-status.index') }}">
                                ...
                                <td class="text-start">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="{{ route('admin.residence.furnished-status.edit', ['furnishedStatus' => $each->id]) }}" class="dropdown-item">Edit</a>
                                            <form action="{{ route('admin.residence.furnished-status.delete', ['furnishedStatus' => $each->id]) }}" method="POST">
                                                @csrf
                                                @method('delete')
