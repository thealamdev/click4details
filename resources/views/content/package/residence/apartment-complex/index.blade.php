...
@section('title', 'Apartment Complex')
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div>
            <h4 class="mb-0">Apartment Complex</h4>
            <p class="mb-0">Manage all the land size-units datalist incl. multi-lang</p>
        </div>
        <div class="dropdown me-1">
            <button size-unit="button" class="btn btn-default dropdown-toggle" id="dropdownMenuOffset" data-bs-toggle="dropdown" aria-expanded="false" data-bs-offset="0,10">
                Quick Navigation
            </button>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuOffset">
                <li>
                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.residence.apartment-complex.create') }}">
                        Create Record<i class="fa-solid fa-plus text-body text-opacity-50"></i>
                    </a>
                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.residence.apartment-complex.index') }}">
                                ...
                                <td class="text-start">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="{{ route('admin.residence.apartment-complex.edit', ['apartmentComplex' => $each->id]) }}" class="dropdown-item">Edit</a>
                                            <form action="{{ route('admin.residence.apartment-complex.delete', ['apartmentComplex' => $each->id]) }}" method="POST">
                                                @csrf
                                                @method('delete')
