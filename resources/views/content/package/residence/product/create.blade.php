...
@section('content')
    <div class="container">
        ...
        <div class="card rounded border border-gray-300">
            <div class="card-body">
                <form action="{{ route('admin.residence.product.store') }}" method="POST" accept-charset="utf-8" autocomplete="on" class="need-validation" novalidate enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                <label class="form-label fw-500 mb-1" for="title[en]">Title in English<span class="ms-1 text-red-600">*</span></label>
                                <input type="text" class="form-control" placeholder="short title in english" name="title[en]" value="{{ old('title.en') }}" required />
                                @error('title.en')
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="short title in bangla" name="title[bn]" value="{{ old('title.bn') }}" required />
                                @error('title.bn')
                                    <div class="invalid-feedback text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <input type="number" name="size" class="form-control" placeholder="enter size">
                        </div>
                        <div class="col-lg-6 mb-3">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <select name="completion_status_id" class="form-control">
                                ...
                                @foreach ($completion_status as $each)
                                    <option value="{{ $each->id }}">{{ toLocaleString($each?->translate, 'en') }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-lg-6 mb-3">
