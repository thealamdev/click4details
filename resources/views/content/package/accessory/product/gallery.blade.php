...
@section('title', 'Accessory Gallery')
@section('content')
    <div class="container">
        ...
        @if (is_object($accessory->gallery) && $accessory->gallery->count() > 0)
            <div class="row row-cols-1 row-cols-lg-3 row-cols-xl-5 g-3 mb-3">
                @foreach ($accessory->gallery as $each)
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body d-flex justify-content-between">
                                ...
                                <div>
                                    <form
                                        action="{{ route('admin.accessory.gallery.delete', ['accessory' => $accessory->id, 'gallery' => $each->id]) }}"
                                        method="POST">
                                        @csrf
                                        @method('delete')
        ...
        <div class="card rounded border border-gray-300">
            <div class="card-body">
                <form action="{{ route('admin.accessory.gallery.store', ['accessory' => $accessory->id]) }}" method="POST"
