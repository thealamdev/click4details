...
<div class="container">
    <div class="d-flex align-items-center justify-content-between">
        <div>
            <h4 class="mb-0">Create Accessory</h4>
            <p>Prior to create resource, make sure asterisk (*) signs are filled</p>
        </div>
    </div>
    <div class="card rounded border border-gray-300">
        <div class="card-body">
            <form action="{{ route('admin.accessory.product.store') }}" method="POST" accept-charset="utf-8" autocomplete="on" class="need-validation" novalidate enctype="multipart/form-data">
                @csrf
                <div class="row gx-3">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            @error('category_id') <div class="invalid-feedback text-red-600">{{ $message }}</div> @enderror
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            @error('merchant_id') <div class="invalid-feedback text-red-600">{{ $message }}</div> @enderror
                        </div>
                    </div>

                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            <label class="form-label fw-500 mb-1" for="purchase_from">Purchase From<span class="ms-1 text-red-600">*</span></label>
                            <input type="text" placeholder="Enter Purchase Client Name" class="form-control @error('purchase_from') {{ 'is-invalid' }} @enderror" name="purchase_from" value="{{ old('purchase_from') }}" />
                            @error('purchase_from') <div class="invalid-feedback text-red-600">{{ $message }}</div> @enderror
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" placeholder="Enter Purchase Price" class="form-control @error('purchase_price') {{ 'is-invalid' }} @enderror" name="purchase_price" value="{{ old('purchase_price') }}" />
                            @error('purchase_price') <div class="invalid-feedback text-red-600">{{ $message }}</div> @enderror
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            <label class="form-label fw-500 mb-1" for="purchase_from">Brands<span class="ms-1 text-red-600">*</span></label>
                             <select name="accessory_brand_id" class="form-control">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            @error('code') <div class="invalid-feedback text-red-600">{{ $message }}</div> @enderror
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            <label class="form-label fw-500 mb-1" for="price">Selling Price<span class="ms-1 text-red-600">*</span></label>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            <label class="form-label fw-500 mb-1" for="price">Quantity<span class="ms-1 text-red-600">*</span></label>
                            <input type="number" placeholder="Enter Quantity" class="form-control @error('price') {{ 'is-invalid' }} @enderror" name="quantity" value="{{ old('quantity') }}" />
                            @error('quantity') <div class="invalid-feedback text-red-600">{{ $message }}</div> @enderror
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            @error('is_approved') <div class="invalid-feedback text-red-600">{{ $message }}</div> @enderror
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            @error('publish_at') <div class="invalid-feedback text-red-600">{{ $message }}</div> @enderror
                        </div>
                    </div>
