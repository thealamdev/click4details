...
@section('title', 'Rental Car')
@section('content')
    <div class="container">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                <h4 class="mb-0">Rental Car</h4>
                <p>Prior to create resource, make sure asterisk (*) signs are filled</p>
            </div>
        </div>
        <div class="card rounded border border-gray-300">
            <div class="card-body">
                <form action="{{ route('admin.rental.service.car.store') }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8" autocomplete="on" class="need-validation" novalidate>
                    @csrf
                    <div class="row g-3">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('brand_id') {{ 'is-invalid' }} @enderror" name="brand_id" required>
                                    ...
                                    @foreach ($composeBrand as $each)
                                        <option value="{{ $each->id }}" @selected(old('brand_id') == $each->id)>
                                            {{ $each->title }}</option>
                                    @endforeach
                                </select>
                                @error('brand_id')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('carmodel_id') {{ 'is-invalid' }} @enderror" name="carmodel_id" required>
                                    ...
                                    @foreach ($composeCarmodel as $each)
                                        <option value="{{ $each->id }}" @selected(old('carmodel_id') == $each->id)>
                                            {{ $each->title }}</option>
                                    @endforeach
                                </select>
                                @error('carmodel_id')
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control" placeholder="Enter Vehicle Total Seat" name="seat" @error('seat')
                                    {{ 'is-invalid' }}  
                                @enderror required>
                                @error('seat')
                                    <div class="invalid-feedback text-red-600">{{ $message }}</div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('color_id') {{ 'is-invalid' }} @enderror" name="color_id" required>
                                    ...
                                    @foreach ($composeColor as $each)
                                        <option value="{{ $each->id }}" @selected(old('color_id') == $each->id)>
                                            {{ $each->title }}</option>
                                    @endforeach
                                </select>
                                @error('color_id')
                        ...
                        <div class="row p-0 m-0">
                            <div class="col-4 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="daily_charge_inside_dhaka" placeholder="Daily Charge Inside Dhaka" class="form-control" @error('daily_charge_inside_dhaka') {{ 'is-invalid' }} @enderror">
                            ...
                            <div class="col-4 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="daily_max_visit_inside" placeholder="Daily Visit Limit Inside Dhaka" class="form-control" @error('daily_max_visit_inside') {{ 'is-invalid' }} @enderror">
                            ...
                            <div class="col-4 col-md-4">
                                <div class="form-group mb-3">
                                    <label class="form-label fw-500 mb-1" for="extra_charge_perkm_daily_inside">Daily Extra Visit Charge Inside Dhaka (Per Km)<span class="ms-1 text-red-600">*</span></label>
                                    <input type="number" name="extra_charge_perkm_daily_inside" placeholder="Daily Extra Visit Charge Inside Dhaka" class="form-control" @error('extra_charge_perkm_daily_inside') {{ 'is-invalid' }} @enderror">
                        ...
                        <div class="row p-0 m-0">
                            <div class="col-4 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="daily_charge_outside_dhaka" placeholder="Daily charge Outside Dhaka" class="form-control" @error('daily_charge_outside_dhaka') {{ 'is-invalid' }} @enderror">
                            ...
                            <div class="col-4 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="daily_max_visit_outside" placeholder="Daily Visit Limit Outside Dhaka" class="form-control" @error('daily_max_visit_outside') {{ 'is-invalid' }} @enderror">
                            ...
                            <div class="col-4 col-md-4">
                                <div class="form-group mb-3">
                                    <label class="form-label fw-500 mb-1" for="extra_charge_perkm_daily_outside">Daily Extra Visit Charge Outside Dhaka(Per Km)<span class="ms-1 text-red-600">*</span></label>
                                    <input type="number" name="extra_charge_perkm_daily_outside" placeholder="Daily Extra Visit Charge Outside Dhaka" class="form-control" @error('extra_charge_perkm_daily_outside') {{ 'is-invalid' }} @enderror">
                        ...
                        <div class="row p-0 m-0">
                            <div class="col-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="monthly_charge_inside_dhaka" placeholder="Monthly Charge Inside Dhaka" class="form-control" @error('monthly_charge_inside_dhaka') {{ 'is-invalid' }} @enderror">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="monthly_max_visit_inside" placeholder="Monthly Visit Limit Inside Dhaka" class="form-control" @error('monthly_max_visit_inside') {{ 'is-invalid' }} @enderror">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group mb-3">
                                    <label class="form-label fw-500 mb-1" for="monthly_max_visit_charge_dai_inside">Monthly Extra Visit Charge Inside Dhaka(Per Km)<span class="ms-1 text-red-600">*</span></label>
                                    <input type="number" name="monthly_max_visit_inside" placeholder="Monthly Extra Visit Charge Inside Dhaka" class="form-control" @error('monthly_max_visit_inside') {{ 'is-invalid' }} @enderror">
                                    @error('monthly_max_visit_inside')
                                        <div class="invalid-feedback text-red-600">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row p-0 m-0">
                            <div class="col-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="monthly_charge_outside_dhaka" placeholder="Monthly charge Outside Dhaka" class="form-control" @error('monthly_charge_outside_dhaka') {{ 'is-invalid' }} @enderror">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="monthly_max_visit_outside" placeholder="Monthly Visit Limit Outside Dhaka" class="form-control" @error('monthly_max_visit_outside') {{ 'is-invalid' }} @enderror">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group mb-3">
                                    <label class="form-label fw-500 mb-1" for="extra_charge_perkm_monthly_outside">Monthly Extra Visit Charge Outside Dhaka(Per Km)<span class="ms-1 text-red-600">*</span></label>
                                    <input type="number" name="extra_charge_perkm_monthly_outside" placeholder="Monthly Visit Limit Outside Dhaka" class="form-control" @error('extra_charge_perkm_monthly_outside') {{ 'is-invalid' }} @enderror">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" value="{{ old('mileages') }}" name="mileages" class="form-control @error('mileages') {{ 'is-invalid' }} @enderror" placeholder="Enter mileages">
                                @error('mileages')
                                    <div class="text-red-600">{{ $message }}</div>
                                @enderror
                            </div>
