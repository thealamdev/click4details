            ...
            <table id="dataTable" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2" class="align-middle">Feature</th>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="{{ route('admin.vehicle.featur.edit', ['featur' => $each->id]) }}"
                                                class="dropdown-item">Detail Add & Update
                                            </a>
                                            <form
                                                action="{{ route('admin.vehicle.featur.delete', ['featur' => $each->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('delete')
