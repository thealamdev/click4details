...
<div class="d-flex align-items-center justify-content-between mb-3">
    <div>
        <h4 class="mb-0">Skeletons</h4>
        <p class="mb-0">Manage all the vehicle fuels incl. multi-lang</p>
    </div>
    <div class="dropdown me-1">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuOffset">
            <li>
                <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.vehicle.skeleton.create') }}">
                    Create Record<i class="fa-solid fa-plus text-body text-opacity-50"></i>
                </a>
                <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.vehicle.skeleton.index') }}">
                    ...
                    <td class="text-center">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="{{ route('admin.vehicle.skeleton.edit', ['skeleton' => $each->id]) }}" class="dropdown-item">Edit</a>
                                <form action="{{ route('admin.vehicle.skeleton.delete', ['skeleton' => $each->id]) }}" method="POST">
                                    @method('DELETE')
                                    @csrf
