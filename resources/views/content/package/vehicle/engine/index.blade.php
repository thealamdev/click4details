...
<div class="d-flex align-items-center justify-content-between mb-3">
    <div>
        ...
        <p class="mb-0">Manage all the vehicle editions datalist incl. multi-lang</p>
    </div>
    <div class="dropdown me-1">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuOffset">
            <li>
                <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.vehicle.engine.create') }}">
                    Create Record<i class="fa-solid fa-plus text-body text-opacity-50"></i>
                </a>
                <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.vehicle.engine.index') }}">
                    ...
                    <td class="text-center">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="{{ route('admin.vehicle.engine.edit', ['engine' => $each->id]) }}" class="dropdown-item">Edit</a>
                                <form action="{{ route('admin.vehicle.engine.delete', ['engine' => $each->id]) }}" method="POST">
                                    @csrf
                                    @method('delete')
