...
<div class="container">
    ...
    <div class="card rounded border border-gray-300">
        <div class="card-body">
            <form action="{{ route('admin.vehicle.grade.update', ['grade' => $grade->id]) }}" method="POST" accept-charset="utf-8" autocomplete="on" class="need-validation" novalidate>
                @csrf
                @method('put')
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('admin.vehicle.grade.index') }}" class="btn btn-default">
