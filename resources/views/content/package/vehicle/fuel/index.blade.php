...
<div class="d-flex align-items-center justify-content-between mb-3">
    ...
    <div class="dropdown me-1">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuOffset">
            <li>
                <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.vehicle.fuel.create') }}">
                    Create Record<i class="fa-solid fa-plus text-body text-opacity-50"></i>
                </a>
                <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.vehicle.fuel.index') }}">
                    ...
                    <td class="text-center">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="{{ route('admin.vehicle.fuel.edit', ['fuel' => $each->id]) }}" class="dropdown-item">Edit</a>
                                <form action="{{ route('admin.vehicle.fuel.delete', ['fuel' => $each->id]) }}" method="POST">
                                    @method('DELETE')
                                    @csrf
