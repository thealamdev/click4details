<form action="{{ route('admin.vehicle.product.store') }}" method="POST" accept-charset="utf-8"
                    ...
                    <div class="row gx-3">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="title[bn]" value="{{ old('title.bn') }}"
                                    required />
                                @error('title.bn')
                                    <div class="invalid-feedback text-red-600">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('mileage_id') {{ 'is-invalid' }} @enderror"
                                    ...
                                    @foreach ($composeMileage as $each)
                                        <option value="{{ $each->id }}" @selected(old('mileage_id') == $each->id)>
                                            {{ $each->title }}</option>
                                    @endforeach
                                </select>
                                @error('mileage_id')
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                <label class="form-label fw-500 mb-1" for="mileages">Mileage<span
                                        class="ms-1 text-red-600">*</span></label>
                                <input type="number" value="{{ old('mileages') }}" name="mileages"
                                    class="form-control @error('mileages')
                                {{ 'is-invalid' }}
                                @enderror"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('engine_id') {{ 'is-invalid' }} @enderror"
                                    ...
                                    @foreach ($composeEngine as $each)
                                        <option value="{{ $each->id }}" @selected(old('engine_id') == $each->id)>
                                            {{ $each->title }}</option>
                                    @endforeach
                                </select>
                                @error('engine_id')
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                <label class="form-label fw-500 mb-1" for="engine_id">Engine<span
                                        class="ms-1 text-red-600">*</span></label>
                                <input type="number" class="form-select @error('engines') {{ 'is-invalid' }} @enderror"
                                    name="engines" value="{{ old('engines') }}" required>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                <label class="form-label fw-500 mb-1" for="additional_price">Additional Price<span
                                        class="ms-1 text-red-600"></span></label>
                                <input type="number" min="10000" placeholder="Enter Additional Price"
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <select name="negotiable"
                                    ...
                                    <option selected disabled>Please Select...</option>
                                    <option value="1" selected @selected(old('negotiable') == '1')>Negotiable</option>
                                    <option value="0" @selected(old('negotiable') == '0')>Fixed</option>
                                </select>
