...
@section('content')
    <div class="container">
                    ...
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body d-flex justify-content-between">
                                ...
                                <div>
                                    <form
                                        action="{{ route('admin.vehicle.gallery.delete', ['vehicle' => $vehicle->id, 'gallery' => $each->id]) }}"
                                        method="POST">
                                        @csrf
                                        @method('delete')
        ...
        <div class="card rounded border border-gray-300">
            <div class="card-body">
                <form action="{{ route('admin.vehicle.gallery.store', ['vehicle' => $vehicle->id]) }}" method="POST"
