...
<div class="d-flex align-items-center justify-content-between mb-3">
    <div>
        <h4 class="mb-0">Transmissions</h4>
        <p class="mb-0">Manage all the vehicle transmissions incl. multi-lang</p>
    </div>
    <div class="dropdown me-1">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuOffset">
            <li>
                <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.vehicle.transmission.create') }}">
                    Create Record<i class="fa-solid fa-plus text-body text-opacity-50"></i>
                </a>
                <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.vehicle.transmission.index') }}">
                    ...
                    <td class="text-center">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="{{ route('admin.vehicle.transmission.edit', ['transmission' => $each->id]) }}" class="dropdown-item">Edit</a>
                                <form action="{{ route('admin.vehicle.transmission.delete', ['transmission' => $each->id]) }}" method="POST">
                                    @method('DELETE')
                                    @csrf
