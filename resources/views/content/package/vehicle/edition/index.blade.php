            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuOffset">
                <li>
                    <a class="dropdown-item d-flex align-items-center justify-content-between"
                        href="{{ route('admin.vehicle.edition.create') }}">
                        Create Record<i class="fa-solid fa-plus text-body text-opacity-50"></i>
                    </a>
                    <a class="dropdown-item d-flex align-items-center justify-content-between"
                        href="{{ route('admin.vehicle.edition.index') }}">
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="{{ route('admin.vehicle.edition.edit', ['edition' => $each->id]) }}"
                                                class="dropdown-item">Edit</a>
                                            <a href="{{ route('admin.vehicle.package.create', ['package' => $each->id]) }}"
                                                class="dropdown-item">Add Package</a>
                                            <form
                                                action="{{ route('admin.vehicle.edition.delete', ['edition' => $each->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('delete')
