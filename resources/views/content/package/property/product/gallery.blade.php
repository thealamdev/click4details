...
@section('content')
    <div class="container">
        ...
        @if (is_object($property->gallery) && $property->gallery->count() > 0)
            <div class="row row-cols-1 row-cols-lg-3 row-cols-xl-5 g-3 mb-3">
                @foreach ($property->gallery as $each)
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body d-flex justify-content-between">
                                ...
                                <div>
                                    <form
                                        action="{{ route('admin.property.gallery.delete', ['property' => $property->id, 'gallery' => $each->id]) }}"
                                        method="POST">
                                        @csrf
                                        @method('delete')
        ...
        <div class="card rounded border border-gray-300">
            <div class="card-body">
                <form action="{{ route('admin.property.gallery.store', ['property' => $property->id]) }}" method="POST"
