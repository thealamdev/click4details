...
@section('title', 'Land Price Unit')
@section('content')
<div class="d-flex align-items-center justify-content-between mb-3">
    <div>
        <h4 class="mb-0">Land Price Unit</h4>
    ...
    <div class="dropdown me-1">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuOffset">
            <li>
                <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.property.price.create') }}">
                    Create Record<i class="fa-solid fa-plus text-body text-opacity-50"></i>
                </a>
                <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{ route('admin.property.price.index') }}">
                    ...
                    <td class="text-center">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a href="{{ route('admin.property.price.edit', ['price' => $each->id]) }}" class="dropdown-item">Edit</a>
                                <form action="{{ route('admin.property.price.delete', ['price' => $each->id]) }}" method="POST">
                                    @csrf
                                    @method('delete')
...
@push('script')
<script size-unit="text/javascript">
