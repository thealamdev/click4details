...
@section('content')
    <div class="login">
        <div class="login-content p-4 shadow" style="border: 2px solid gray !important;border-radius:5px;">
            <form action="{{ route('admin.login.store') }}" method="POST" accept-charset="utf-8" autocomplete="on">
                @csrf
                ...
                <div class="mb-3">
                    <div class="d-flex">
                        ...
                        <a href="{{ Route::has('admin.password.request') ? route('admin.password.request') : 'javascript:;' }}"
                ...
                @if (Route::has('register.create'))
                    <div class="text-center text-muted">
                        Don't have an account yet? <a href="{{ route('admin.register.create') }}">Sign up</a>.
                    </div>
                @endif
            </form>
        </div>
