...
<div class="login">
    <div class="login-content">
        <form action="{{ route('client.password.email') }}" method="POST" accept-charset="utf-8" autocomplete="on">
            @csrf
            ...
            <div class="text-center text-muted">
                Remember your password? <a href="{{ route('client.login.create') }}">Sign in</a>.
            </div>
            @endif
        </form>
    </div>
