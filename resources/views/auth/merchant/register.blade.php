...
@section('content')
    <div class="login">
        <div class="login-content">
            <form action="{{ route('merchant.register.store') }}" method="POST" accept-charset="utf-8" autocomplete="on">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="mobile" id="mobile" class="form-control form-control-lg fs-15px"
                ...
                @if (Route::has('merchant.login.create'))
                    <div class="text-muted text-center">
                        Already have an Admin ID? <a href="{{ route('merchant.login.create') }}">Sign In</a>
                    </div>
                @endif
            </form>
        </div>
